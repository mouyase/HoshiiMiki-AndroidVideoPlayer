...
package faker.flame.danmaku.controller;
...
import faker.flame.danmaku.controller.CacheManagingDrawTask;
import faker.flame.danmaku.controller.DrawTask;
import faker.flame.danmaku.controller.IDanmakuViewController;
import faker.flame.danmaku.controller.IDrawTask;
import faker.flame.danmaku.controller.UpdateThread;
import faker.flame.danmaku.danmaku.model.AbsDanmakuSync;
import faker.flame.danmaku.danmaku.model.AbsDisplayer;
import faker.flame.danmaku.danmaku.model.BaseDanmaku;
import faker.flame.danmaku.danmaku.model.DanmakuTimer;
import faker.flame.danmaku.danmaku.model.IDanmakus;
import faker.flame.danmaku.danmaku.model.IDisplayer;
import faker.flame.danmaku.danmaku.model.android.DanmakuContext;
import faker.flame.danmaku.danmaku.parser.BaseDanmakuParser;
import faker.flame.danmaku.danmaku.renderer.IRenderer.RenderingState;
import faker.flame.danmaku.danmaku.util.SystemClock;
import faker.flame.jni.DeviceUtils;
...
public class DrawHandler extends Handler {
    ...
    public faker.flame.danmaku.controller.IDrawTask drawTask;
        ...
        switch (what) {
            ...
            case RESUME:
                ...
                if (mReady) {
                    ...
                    if (drawTask != null) {
                        drawTask.onPlayStateChanged(faker.flame.danmaku.controller.IDrawTask.PLAY_STATE_PLAYING);
                    }
                } else {
            ...
            case PAUSE:
                ...
                if (drawTask != null) {
                    drawTask.onPlayStateChanged(faker.flame.danmaku.controller.IDrawTask.PLAY_STATE_PAUSE);
                }
            case QUIT:
                if (what == QUIT) {
...
//                + mCordonTime + ",mFrameRefreshingRate:" + mFrameUpdateRate);
    ...
    private void prepare(final Runnable runnable) {
        if (drawTask == null) {
            drawTask = createDrawTask(mDanmakuView.isDanmakuDrawingCacheEnabled(), timer,
                    ...
                    mDanmakuView.isHardwareAccelerated(), new faker.flame.danmaku.controller.IDrawTask.TaskListener() {
                        @Override
                        public void ready() {
    ...
    private faker.flame.danmaku.controller.IDrawTask createDrawTask(boolean useDrwaingCache, DanmakuTimer timer,
                                                                     Context context,
                                                                     int width, int height,
                                                                     boolean isHardwareAccelerated,
                                                                     faker.flame.danmaku.controller.IDrawTask.TaskListener taskListener) {
