...
public class AndroidDisplayer extends AbsDisplayer<Canvas, Typeface> {
    ...
    public void resetSlopPixel(float factor) {
        float d = Math.max(factor, getWidth() / faker.flame.danmaku.danmaku.model.android.DanmakuFactory.BILI_PLAYER_WIDTH); //correct for low density and high resolution
