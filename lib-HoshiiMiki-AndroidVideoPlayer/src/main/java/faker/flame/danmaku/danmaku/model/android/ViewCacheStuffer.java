...
public abstract class ViewCacheStuffer<VH extends ViewCacheStuffer.ViewHolder> extends BaseCacheStuffer {
    ...
    public static abstract class ViewHolder {
        ...
        public void draw(Canvas canvas, faker.flame.danmaku.danmaku.model.android.AndroidDisplayer.DisplayerConfig displayerConfig) {
    ...
    public abstract void onBindViewHolder(int viewType, VH viewHolder, BaseDanmaku danmaku, faker.flame.danmaku.danmaku.model.android.AndroidDisplayer.DisplayerConfig displayerConfig, TextPaint paint);
