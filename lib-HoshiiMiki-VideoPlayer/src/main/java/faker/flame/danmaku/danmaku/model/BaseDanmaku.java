...
public abstract class BaseDanmaku {
     ...
     * 存活时间(毫秒)
     */
    public faker.flame.danmaku.danmaku.model.Duration duration;
    ...
    public int draw(faker.flame.danmaku.danmaku.model.IDisplayer displayer) {
    ...
    public void measure(faker.flame.danmaku.danmaku.model.IDisplayer displayer, boolean fromWorkerThread) {
    ...
    public void prepare(faker.flame.danmaku.danmaku.model.IDisplayer displayer, boolean fromWorkerThread) {
    ...
    public abstract void layout(faker.flame.danmaku.danmaku.model.IDisplayer displayer, float x, float y);
