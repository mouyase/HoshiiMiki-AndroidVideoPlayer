 ...
 * The cacing policy apply to {@link faker.flame.danmaku.controller.CacheManagingDrawTask}
 * 提供缓存相关的策略设置: <br/>
...
//    public DanmakuTimer recyleTimer = new DanmakuTimer(SystemClock.uptimeMillis());
    ...
    /**
     * @see faker.flame.danmaku.controller.CacheManagingDrawTask.CacheManager#findReusableCache
     */
