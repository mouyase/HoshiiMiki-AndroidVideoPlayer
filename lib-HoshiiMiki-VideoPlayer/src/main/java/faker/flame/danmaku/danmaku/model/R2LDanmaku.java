...
public class R2LDanmaku extends BaseDanmaku {
    ...
    @Override
    public void layout(faker.flame.danmaku.danmaku.model.IDisplayer displayer, float x, float y) {
        if (mTimer != null) {
    ...
    protected float getAccurateLeft(faker.flame.danmaku.danmaku.model.IDisplayer displayer, long currTime) {
    ...
    @Override
    public float[] getRectAtTime(faker.flame.danmaku.danmaku.model.IDisplayer displayer, long time) {
        if (!isMeasured())
            return null;
