...
import com.tencent.liteav.play.common.TCPlayerConstants;
import com.tencent.liteav.play.net.LogReport;
...
import com.tencent.liteav.play.view.TCVodMoreView;
import com.tencent.liteav.play.view.TCVodQualityView;
...
//    }
    private void initViews(Context context) {
        ...
        mIvDanmuku = findViewById(R.id.iv_danmuku);
        mIvMore = findViewById(R.id.iv_more);
        mIvSnapshot = findViewById(R.id.iv_snapshot);
        ...
        mTvVttText.setOnClickListener(v -> {
        ...
        if (!SuperPlayerGlobalConfig.getInstance().enableDanmaku) {
            mIvDanmuku.setVisibility(GONE);
        }
        if (!SuperPlayerGlobalConfig.getInstance().enableCapture) {
            mIvSnapshot.setVisibility(GONE);
        }
        if (!SuperPlayerGlobalConfig.getInstance().enableDefinition) {
            mTvQuality.setVisibility(GONE);
        }
    }
