...
import com.tencent.liteav.play.controller.TCVodControllerBase;
...
import com.tencent.liteav.play.v3.SuperPlayerModelWrapper;
import com.tencent.liteav.play.v3.SuperPlayerVideoId;
import com.tencent.liteav.play.v3.SuperVodInfoLoaderV3;
...
public class SuperPlayerView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener {
    ...
    private void initView(Context context) {
        ...
        mVodControllerFloat = mRootView.findViewById(R.id.controller_float);
    ...
    private void showSmallCoverPic(final String coverUrl) {
        ...
        mTXCloudVideoView.post(() -> AsyncTask.execute(() -> {
            Bitmap bmp = null;
            InputStream in = null;
            try {
...
//                mWindowParams.type = WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
        ...
        public void onBackPress(int playMode) {
            if (SuperPlayerGlobalConfig.getInstance().enableFullWindow) {
