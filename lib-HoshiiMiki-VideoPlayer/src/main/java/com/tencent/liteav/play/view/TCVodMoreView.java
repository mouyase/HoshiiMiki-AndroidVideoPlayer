...
public class TCVodMoreView extends RelativeLayout implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void init(Context context) {
        ...
        mLayoutSpeed = findViewById(R.id.layout_speed);
        mRadioGroup = findViewById(R.id.radioGroup);
        mRbSpeed1 = findViewById(R.id.rb_speed1);
        mRbSpeed125 = findViewById(R.id.rb_speed125);
        mRbSpeed15 = findViewById(R.id.rb_speed15);
        mRbSpeed2 = findViewById(R.id.rb_speed2);

        mRadioGroup.setOnCheckedChangeListener(this);
        mSeekBarVolume = findViewById(R.id.seekBar_audio);
        mSeekBarLight = findViewById(R.id.seekBar_light);

        mLayoutMirror = findViewById(R.id.layout_mirror);
        mSwitchMirror = findViewById(R.id.switch_mirror);

        mSwitchAccelerate = findViewById(R.id.switch_accelerate);
